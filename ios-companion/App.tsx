...
const styles: Record<string, any> = new Proxy(StyleSheet.create({
  ...
  header: { paddingTop: 20, paddingBottom: 10, paddingLeft: 20, paddingRight: 32, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  headerCopy: { flexShrink: 1 },
  headerActions: { flexDirection: "row", alignItems: "center", gap: 7, marginLeft: 8, marginRight: 8 },
  headerAction: { backgroundColor: "#257863", borderRadius: 12, paddingHorizontal: 13, paddingVertical: 10 },
