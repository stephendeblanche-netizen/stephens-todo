...
import { ActivityIndicator, Alert, FlatList, Keyboard, KeyboardAvoidingView, Linking, Modal, Platform, Pressable, RefreshControl, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, View, useWindowDimensions } from "react-native";
...
const styles: Record<string, any> = new Proxy(StyleSheet.create({
  ...
  taskSetupScroll: { flex: 1, flexShrink: 1, maxHeight: "88%" },
  taskSetupScrollContent: { flexGrow: 0, justifyContent: "flex-end", paddingTop: 12 },
