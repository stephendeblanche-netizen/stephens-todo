...
type Sheet = "menu" | "task" | "category" | "subCategory" | "directReport" | "manageCategories" | "manageReports" | "reorderSubcategories" | "reorderTasks" | "moveTask" | "bulkMove" | "selectCategory" | "selectParent" | "selectLandingCategory" | "selectLandingResponsibleColleague" | null;
...
export default function App() {
  ...
  const closeSheet = () => { setSheet(null); setText(""); setEditingCategory(null); setEditingReport(null); setSubCategoryParent(null); setSelectedDestinationCategoryId(null); setSelectedParentTaskId(null); setNewCategoryName(""); setNewParentTaskName(""); setCreatingNewCategory(false); setCreatingNewParent(false); setDestinationPickerOrigin(null); setReorderParent(null); setReorderCategoryId(null); setMovingTask(null); setNewTaskPriority("medium"); setNewTaskDueAt(null); setNewTaskRecurrence("none"); setNewTaskAccountableDirectReportId(null); setShowDueDatePicker(false); };
  const openSheet = (next: Exclude<Sheet, null>) => { haptic(); setText(""); setNewCategoryName(""); setNewParentTaskName(""); setCreatingNewCategory(false); setCreatingNewParent(false); setDestinationPickerOrigin(null); setNewTaskPriority("medium"); setNewTaskDueAt(null); setNewTaskRecurrence("none"); setNewTaskAccountableDirectReportId(null); setShowDueDatePicker(false); setSheet(next); };
